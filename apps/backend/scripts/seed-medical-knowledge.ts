/**
 * Comprehensive Medical Knowledge Base Seed Script
 *
 * Seeds the MedicalKnowledge collection with 80+ entries covering:
 * - Lab test reference ranges and clinical significance
 * - ECG parameters and cardiac conditions
 * - Imaging findings by modality (CT, MRI, X-ray, USG)
 * - Common conditions and differential diagnoses
 * - Bangladesh-specific medical context
 * - Diet and lifestyle recommendations
 *
 * Usage:
 *   npx ts-node scripts/seed-medical-knowledge.ts
 *   npx ts-node scripts/seed-medical-knowledge.ts --reset   # clear & re-seed
 */
...
const KNOWLEDGE_ENTRIES: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    tags: ['wbc', 'leukocytes', 'neutrophils', 'lymphocytes', 'eosinophils', 'infection', 'dengue'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
  ...
  },
  {
    ...
    tags: ['hemoglobin', 'anemia', 'mcv', 'iron deficiency', 'thalassemia', 'ferritin', 'b12'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
    ...
    tags: ['esr', 'crp', 'inflammation', 'infection', 'tb', 'autoimmune', 'cardiovascular'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['alt', 'sgpt', 'ast', 'sgot', 'liver', 'hepatitis', 'fatty liver', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
    ...
    tags: ['bilirubin', 'jaundice', 'liver', 'hemolysis', 'gilbert', 'gallstones'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
  ...
  },
  {
    ...
    tags: ['sodium', 'potassium', 'electrolytes', 'hyponatremia', 'hyperkalemia', 'kidney'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['blood sugar', 'glucose', 'diabetes', 'fasting', 'prediabetes', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
    ...
    tags: ['hba1c', 'diabetes', 'glycated hemoglobin', 'blood sugar', 'thalassemia'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['cholesterol', 'ldl', 'hdl', 'triglycerides', 'lipid', 'cardiovascular', 'heart'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['tsh', 'thyroid', 't3', 't4', 'hypothyroid', 'hyperthyroid', 'hashimoto', 'graves'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['iron', 'ferritin', 'tibc', 'transferrin', 'anemia', 'iron deficiency', 'hemochromatosis'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['vitamin d', 'deficiency', 'bone', 'osteoporosis', 'calcium', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
    ...
    tags: ['vitamin b12', 'folate', 'macrocytic', 'anemia', 'neuropathy', 'metformin'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['pt', 'inr', 'aptt', 'coagulation', 'warfarin', 'bleeding', 'dic', 'dengue'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['urinalysis', 'urine', 'protein', 'uti', 'microalbumin', 'kidney', 'diabetes'],
    source: 'medical-reference',
  },
  ...
  },
  {
    ...
    tags: ['bradycardia', 'ecg', 'heart rate', 'slow', 'pacemaker', 'beta blocker'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['tachycardia', 'ecg', 'heart rate', 'fast', 'fever', 'dehydration', 'anemia'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['av block', 'first degree', 'pr interval', 'ecg', 'conduction', 'benign'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['av block', 'second degree', 'wenckebach', 'mobitz', 'ecg', 'dropped beat'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['av block', 'second degree', 'mobitz type ii', 'ecg', 'pacemaker', 'dangerous'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['complete heart block', 'third degree', 'av block', 'ecg', 'pacemaker', 'emergency'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['atrial fibrillation', 'af', 'afib', 'irregular', 'ecg', 'stroke', 'anticoagulation'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['bundle branch block', 'lbbb', 'rbbb', 'ecg', 'qrs', 'conduction', 'stemi'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['st elevation', 'st depression', 'stemi', 'ischemia', 'ecg', 'heart attack', 'pericarditis'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['qt prolongation', 'long qt', 'qtc', 'torsades', 'ecg', 'arrhythmia', 'drug induced'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['lvh', 'hypertrophy', 'ecg', 'hypertension', 'heart', 'voltage criteria'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['pvc', 'premature ventricular', 'ectopic', 'palpitations', 'ecg', 'arrhythmia'],
    source: 'ecg-reference',
  },
...

  {
    ...
    tags: ['pulmonary nodule', 'lung', 'ct', 'fleischner', 'cancer', 'tb', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_ct',
    ...
    tags: ['fatty liver', 'nafld', 'steatosis', 'liver', 'ct', 'ultrasound', 'imaging', 'bangladesh'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_ct',
    ...
    tags: ['kidney stones', 'nephrolithiasis', 'hydronephrosis', 'ct', 'usg', 'renal', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_ct',
    ...
    tags: ['stroke', 'ct head', 'ischemic', 'hemorrhage', 'aspects', 'brain', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['disc herniation', 'spine', 'mri', 'back pain', 'sciatica', 'pfirrmann', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_mri',
    ...
    tags: ['white matter', 'hyperintensities', 'mri brain', 'fazekas', 'small vessel', 'dementia', 'ms'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_mri',
    ...
    tags: ['meniscal tear', 'acl', 'knee', 'mri', 'ligament', 'cartilage', 'orthopedic', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['chest xray', 'cxr', 'pneumonia', 'effusion', 'cardiomegaly', 'tb', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_xray',
    ...
    tags: ['fracture', 'xray', 'bone', 'colles', 'salter harris', 'orthopedic', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['gallstones', 'cholecystitis', 'ultrasound', 'usg', 'biliary', 'gallbladder', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_usg',
    ...
    tags: ['thyroid nodule', 'tirads', 'ultrasound', 'usg', 'thyroid cancer', 'fna', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_usg',
    ...
    tags: ['renal cyst', 'bosniak', 'kidney', 'ultrasound', 'ct', 'imaging', 'cancer'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['thalassemia', 'hbe', 'anemia', 'mcv', 'iron', 'hemoglobin electrophoresis', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['dengue', 'fever', 'thrombocytopenia', 'platelets', 'monsoon', 'bangladesh', 'ns1'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['hepatitis b', 'hbv', 'liver', 'hbsag', 'cirrhosis', 'hcc', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['tb', 'tuberculosis', 'afb', 'genexpert', 'chest xray', 'cavitation', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['ckd', 'kidney', 'creatinine', 'egfr', 'proteinuria', 'dialysis', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['arsenic', 'groundwater', 'skin', 'cancer', 'poisoning', 'bangladesh', 'environmental'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['iron', 'anemia', 'diet', 'bangladeshi food', 'vegetables', 'fish', 'cooking'],
  ...
  },
  {
    ...
    tags: ['diabetes', 'diet', 'blood sugar', 'rice', 'bangladeshi food', 'glycemic index'],
    source: 'nutrition-reference',
  },
  {
    category: 'diet',
    ...
    tags: ['heart', 'cardiovascular', 'diet', 'salt', 'omega-3', 'cholesterol', 'bangladeshi food'],
    source: 'nutrition-reference',
  },
  {
    category: 'diet',
    ...
    tags: ['kidney', 'ckd', 'diet', 'potassium', 'phosphorus', 'protein', 'bangladeshi food'],
    source: 'nutrition-reference',
  },
  {
    category: 'diet',
    ...
    tags: ['anti-inflammatory', 'crp', 'esr', 'autoimmune', 'turmeric', 'diet', 'bangladeshi food'],
    source: 'nutrition-reference',
  },
  {
    category: 'diet',
    ...
    tags: ['calcium', 'vitamin d', 'osteoporosis', 'bone', 'diet', 'fish', 'bangladeshi food'],
    source: 'nutrition-reference',
  },
...

  {
    ...
    tags: ['calcium', 'phosphate', 'parathyroid', 'vitamin d', 'hypercalcemia', 'ckd'],
    source: 'medical-reference',
  },
  {
    category: 'lab_test',
    ...
    tags: ['liver function', 'hepatocellular', 'cholestatic', 'drug induced', 'alt', 'ast', 'alp'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['aortic aneurysm', 'aaa', 'dissection', 'ct', 'vascular', 'emergency', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_mri',
    ...
    tags: ['brain tumor', 'glioblastoma', 'meningioma', 'metastasis', 'mri brain', 'imaging'],
    source: 'radiopaedia',
  },
  {
    category: 'imaging_xray',
    ...
    tags: ['pneumonia', 'chest xray', 'consolidation', 'tb', 'infection', 'lung', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['wpw', 'wolff parkinson white', 'pre-excitation', 'delta wave', 'ecg', 'accessory pathway'],
    source: 'ecg-reference',
  },
  {
    category: 'ecg_condition',
    ...
    tags: ['axis deviation', 'lad', 'rad', 'lafb', 'ecg', 'lvh', 'pe', 'fascicular block'],
    source: 'ecg-reference',
  },
...

  {
    ...
    tags: ['mammography', 'birads', 'breast', 'cancer', 'screening', 'biopsy', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['tumor markers', 'afp', 'cea', 'ca125', 'ca199', 'psa', 'cancer', 'screening'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['metabolic syndrome', 'south asian', 'waist circumference', 'triglycerides', 'diabetes', 'cardiovascular'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['rheumatic heart', 'rhd', 'mitral valve', 'streptococcal', 'aso', 'ecg', 'bangladesh'],
    source: 'medical-reference',
  },
  {
    category: 'condition',
    ...
    tags: ['hypothyroidism', 'tsh', 'hashimoto', 'thyroid', 'levothyroxine', 'anti-tpo', 'bangladesh'],
    source: 'medical-reference',
  },
...

  {
    ...
    tags: ['pet ct', 'fdg', 'suv', 'deauville', 'lymphoma', 'cancer', 'staging', 'imaging'],
    source: 'radiopaedia',
  },
...

  {
    ...
    tags: ['pregnancy', 'prenatal', 'hemoglobin', 'gdm', 'hellp', 'tsh', 'preeclampsia'],
    source: 'medical-reference',
  },
];
...
async function seedKnowledge(reset = false) {
  console.log('🧠 Medical Knowledge Base Seeder');
  console.log('================================\n');
  ...
  if (reset) {
    ...
    if (count > 0) {
      console.log(
        `⚠️  Knowledge base already has ${count} entries. Use --reset to clear and re-seed.\n`,
      );
      return;
    }
  }
  ...
  for (let i = 0; i < KNOWLEDGE_ENTRIES.length; i++) {
    ...
    const progress = `[${i + 1}/${KNOWLEDGE_ENTRIES.length}]`;
    ...
    try {
      ...
      // Rate limit: Gemini embedding API has limits
      // ~1500 RPM for text-embedding-004, add small delay
      if (i < KNOWLEDGE_ENTRIES.length - 1) {
        await new Promise((r) => setTimeout(r, 200));
      }
    } catch (err: any) {
      console.error(`  ❌ ${progress} ${entry.title}: ${err.message}`);
      failed++;
      ...
      if (err.message?.includes('429') || err.message?.includes('quota')) {
        ...
        i--; // retry this entry
        failed--; // don't count as failed yet
      }
    }
  }
